...
```{r echo=FALSE, fig.cap="Figure 10.1: The effect of bagging 100 base learners. High variance models such as decision trees (C) benefit the most from the aggregation effect in bagging, whereas low variance models such as polynomial regression (A) show little improvement."}
knitr::ininclude_graphics("image/bagging-multiple-models-1.png")
```
...
```{r fig.cap="Figure 10.2: Error curve for bagging 1-200 deep, unpruned decision trees. The benefit of bagging is optimized at 187 trees although the majority of error reduction occurred within the first 100 trees."}
